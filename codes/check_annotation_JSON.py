...
annotation_file = '/data/glosat/Appen/Annotation/cell_check/WSI/Ingredients/batches/batch10/Appen-annotation/new/job_2114134.json'
...
work_dir = f'/data/glosat/Appen/Annotation/cell_check/WSI/Ingredients/batches/batch10'

for i in range(len(info)):
    worker_id =info[i]['results']['judgments'][0]['worker_id']
    image_name = info[i]['data']['filename']

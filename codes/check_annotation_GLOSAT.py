...
work_dir = f'/data/glosat/Appen/Annotation/cell_check/GlOSAT/batches/batch5'
annotation_file = f'{work_dir}/Annotation_info/f2149958.csv'
...
if not os.path.exists(f"{work_dir}/Appen"):
    os.mkdir(f"{work_dir}/Appen")
...
for i in range(len(data)):
    ...
    if missed:
        im_pil.save(f"{work_dir}/Appen/missed_{image_id}_{image_name}.jpg")
        print(f'missed {image_id}\t{image_name}')

    else:
        im_pil.save(f"{work_dir}/Appen/{image_name}.jpg")